...
public class NoteController {
	...
	@RequestMapping(value = "/rest/notes", method = RequestMethod.GET, params = {"userId"})
	@ResponseBody
	...
	@RequestMapping(value = "/rest/notes", method = RequestMethod.DELETE, params = {"noteId"})
	@ResponseBody
	public void deleteNote(@RequestParam UUID noteId) throws UserNotFoundException {
		notes.removeNote(noteId);
	}

	@RequestMapping(value = "/rest/notes/usersWithNotes", method = RequestMethod.GET)
	@ResponseBody
